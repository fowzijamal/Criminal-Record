                    ...
                    <div class="body-area w-100 pr-5">
                        ...
                        <form method="post">
                            <div class="form-group">
                                <label for="exampleFormControlInput2"> Crime Category</label>
                                <input name="Name" type="text" class="form-control" id="exampleFormControlInput2" required>
                            </div>

                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Description</label>
                                <textarea name="desription" class="form-control" id="exampleFormControlTextarea1" rows="3" required></textarea>
                            </div>
                            <button type="submit" name="add_crimecategory" class="btn btn-primary">Submit</button>
                        </form>
                    </div>
