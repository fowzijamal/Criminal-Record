    ...
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="home.php">
        ...
        <div class="sidebar-brand-text mx-3">CRIMINAL RECORD</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
               <a class="collapse-item" href="report-police.php">Police Report</a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseadminPages" aria-expanded="true"
          ...
          <span>Registeration section</span>
        </a>
        <div id="collapseadminPages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="admin-addcourt.php">Add Court</a>
                <a class="collapse-item" href="admin-crimecategory.php">Add Criminal Category</a>
